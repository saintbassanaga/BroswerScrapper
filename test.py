...
class TestWebsite:
    ...
    def test_tools_menu(self):
        ...
        menu_popup = self.browser.find_element_by_css_selector("div[data-test='main-submenu']")
    ...
    def test_navigation_to_all_tools(self):
        ...
        products_list = self.browser.find_element_by_id("products-page")
    ...
    def test_search(self):
        ...
        search_button = self.browser.find_element_by_css_selector("[data-test='site-header-search-action']")
        search_button.click()

        search_field = self.browser.find_element_by_css_selector("[data-test='search-input']")
        search_field.send_keys("Selenium")

        submit_button = self.browser.find_element_by_css_selector("button[data-test='full-search-button']")
        submit_button.click()

        search_page_field = self.browser.find_element_by_css_selector("input[data-test='search-input']")
